...
public:
    ...
    const nnLayer_t& getNNL() const noexcept;
    // ========= NN ==============
...
private:
    ...
    void updateNN_(undoRec_ rec, SQ newRPos, SQ rPos, SQ newKPos, SQ enpassPos, bool undo) noexcept;
};
...
inline const BoardState::nnLayer_t& BoardState::getNNL() const noexcept {
    return m_nnLayer;
}
